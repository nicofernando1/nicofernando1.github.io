...
<head>
    ...
    <div class="top-text">
        <nav class="navbar bg-body-tertiary" style="text-align: center;"> <h2><?= $subjudul?></h2>
    </div>
        <div class="container">
    ...
    <?= form_open('adduser/on_adduser')?>
        <div class="w3l-login-form">
            ...
            <div class="form pt-0 pb-2 d-flex justify-content-end">
                <small class="text-light">&nbsp; <a href="<?= base_url('ticket') ?>" class="btn btn-sm bg-light">Kembali</a></small>
            </div>

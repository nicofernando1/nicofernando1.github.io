              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  <label class="form-control-label" for="desc">Uraian masalah :</label>
                    <input name="description" style="height: 25px;" value="<?= $isidata->Uraianmasalah ?>" class="form-control form-control" id="desc" autocomplete="off"></input>
                </div>
                  ...
                  <div class="col-6">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="statu" placeholder="<?= $isidata->status ?>"> 
                        <?php foreach ($isiloc as $lok) {?>
                          <option value="<?=$lok->name_status?>"><?= $lok->name_status?></option>
                          <?php } ?>

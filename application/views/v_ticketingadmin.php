                ...
                <table class="table  table-head-fixed text-nowrap table table-sm" style="width:100%;">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      ?>
                      <td>
                        <a href="<?= site_url('ticket/updateAdm/'.$key->Id_Ticket)?>" class="btn btn-success"><i class="fa fa-edit"></i><a/>
                        <a href="<?= site_url('ticket/delete/'.$key->Id_Ticket) ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                      </td>  
                    </tr>
                    <?php }?>
                  </tbody>
